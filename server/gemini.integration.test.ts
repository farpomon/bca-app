  ...
  GoogleGenAI: vi.fn().mockImplementation(() => ({
    models: {
      generateContent: vi.fn().mockResolvedValue({
        text: JSON.stringify({
          description: "HVAC system showing moderate wear with some corrosion on ductwork connections",
          condition: "fair",
          recommendation: "Schedule preventive maintenance within 6-12 months. Clean and inspect ductwork connections.",
          confidence: "medium",
        }),
      }),
    },
