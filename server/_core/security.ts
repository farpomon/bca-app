...
export function configureSecurityHeaders() {
  return helmet({
    ...
    contentSecurityPolicy: {
      directives: {
        defaultSrc: ["'self'"],
        scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://forge.manus.ai", "https://forge.butterfly-effect.dev", "https://*.googleapis.com", "https://*.gstatic.com", process.env.VITE_ANALYTICS_ENDPOINT || ""], // unsafe-inline needed for React, forge domains for Maps proxy, analytics
        styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com"],
        fontSrc: ["'self'", "https://fonts.gstatic.com"],
        imgSrc: ["'self'", "data:", "https:", "blob:"], // Allow S3 images
        connectSrc: ["'self'", "https://forge.manus.ai", "https://forge.butterfly-effect.dev", "https://*.googleapis.com", process.env.VITE_ANALYTICS_ENDPOINT || ""],
        frameSrc: ["'none'"],
        objectSrc: ["'none'"],
