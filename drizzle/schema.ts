...
export const assessments = mysqlTable("assessments", {
	...
	recommendedAction: mysqlEnum(['none','monitor','preventive_maintenance','repair','replace','immediate_action']),
	estimatedRepairCost: decimal({ precision: 12, scale: 2 }),
	priorityLevel: mysqlEnum(['1','2','3','4','5']),
	remainingLifeYears: int(),
	quantity: decimal({ precision: 10, scale: 2 }),
	unit: varchar({ length: 50 }),
	location: varchar({ length: 255 }),
	accessibilityIssue: int(),
	safetyHazard: int(),
	...
	reviewYear: int(),
	lastTimeAction: int(),
	replacementValue: decimal({ precision: 15, scale: 2 }),
	actionYear: int(),
	actionDescription: text(),
	repairCost: decimal({ precision: 12, scale: 2 }),
	renewCost: decimal({ precision: 12, scale: 2 }),
...
export const assets = mysqlTable("assets", {
	...
	categoryId: int(),
	name: varchar({ length: 255 }).notNull(),
	assetCode: varchar({ length: 100 }).notNull(),
	description: text(),
	address: text(),
	streetNumber: varchar({ length: 50 }),
	...
	yearBuilt: int(),
	yearRenovated: int(),
	squareFootage: decimal({ precision: 12, scale: 2 }),
	numberOfFloors: int(),
	numberOfUnits: int(),
	occupancyType: mysqlEnum(['occupied','vacant','partially_occupied','seasonal']),
	ownershipType: mysqlEnum(['municipal','state','federal','private','mixed']),
	constructionType: varchar({ length: 100 }),
	primaryUse: varchar({ length: 255 }),
	secondaryUse: varchar({ length: 255 }),
	replacementValue: decimal({ precision: 15, scale: 2 }),
	insuranceValue: decimal({ precision: 15, scale: 2 }),
	annualMaintenanceCost: decimal({ precision: 12, scale: 2 }),
	lastInspectionDate: timestamp({ mode: 'string' }),
	nextInspectionDate: timestamp({ mode: 'string' }),
...
export const backupSchedules = mysqlTable("backup_schedules", {
	...
	lastRunBackupId: int(),
	emailOnSuccess: int().default(0).notNull(),
	emailOnFailure: int().default(1).notNull(),
